...
public class AccountController {
    ...
    @Operation(
        summary = "Get account by ID",
        description = "Retrieves a specific bank account by its ID. This endpoint is used for transfer operations and does not require the account to belong to the authenticated customer."
    )
    @ApiResponse(responseCode = "200", description = "Account retrieved successfully")
    @GetMapping("/{accountId}")
